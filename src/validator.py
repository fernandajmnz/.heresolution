...
def validar_errores():
    ...
    pois_geo = gpd.GeoDataFrame(df, geometry="geometry", crs="EPSG:4326")

    calles = gpd.read_file("data/STREETS_NAV/SREETS_NAV_4815075.geojson").explode(index_parts=False).reset_index(drop=True)
